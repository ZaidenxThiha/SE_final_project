-- =============================================
-- AWEfinal Database - Complete Setup Script
-- =============================================
-- This script creates the complete database schema
-- including tables, indexes, foreign keys, and seed data
-- =============================================
...
GO
CREATE NONCLUSTERED INDEX [IX_Products_InStock] ON [Products] ([InStock]);
GO
...
VALUES 
    ...
    ('JBL Charge 5', 4999.00, 'Speakers', 'Portable waterproof speaker with powerful bass', NULL, '["Black", "Blue", "Red", "Gray"]', 4.0, '[]', '["IP67 waterproof & dustproof", "20 hours playtime", "PartyBoost feature", "Powerbank function", "Deep bass radiators"]', 1, GETUTCDATE()),
    
    ('ASUS ROG Swift PG27UQ', 28999.00, 'Monitors', '4K gaming monitor with HDR and 144Hz', NULL, '["Black"]', 5.0, '[]', '["27-inch 4K UHD display", "144Hz refresh rate", "G-SYNC Ultimate", "HDR1000 certification", "Quantum-dot technology"]', 1, GETUTCDATE()),
    
    ('OnePlus 12', 19999.00, 'Smartphones', 'Flagship killer with Hasselblad camera system', '256GB', '["Flowy Emerald", "Silky Black"]', 4.0, '[]', '["6.82-inch LTPO AMOLED", "Snapdragon 8 Gen 3", "Hasselblad camera system", "100W SUPERVOOC charging", "5400mAh battery"]', 1, GETUTCDATE()),
